      ...
      for (sorteio = 0; sorteio <= 4; sorteio++) {
         ...
         while ((pontuacaoUsuario < 21) && (trava === false)) {
            ...
            pontuacaoUsuario += carta.valor
               ...
               trava = true;
               alert("Suas cartas são "  + cartasUsuario + ". Sua pontuação é " + pontuacaoUsuario + ". As cartas do computador são " + cartasComputador + ". A pontuação do computador é " + pontuacaoComputador + mensagem)
            }
         }
